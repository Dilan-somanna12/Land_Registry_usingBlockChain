...
import { FiBriefcase, FiMail, FiPhone, FiMapPin, FiShield, FiLock, FiCheckCircle } from 'react-icons/fi'
...
class Bank_Register extends Component {
  constructor(props) {
    super(props)
    this.state = {
      bankName: '',
  ...
  handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3001/api/bank/register', data)
      
      if (response.status === 200) {
        alert('Bank registration successful! Your account is pending government approval. You will be notified once approved.')
      ...
      <PageContainer>
        ...
        >
          <Header>
            ...
            <Subtitle>Register your bank to provide mortgage services</Subtitle>
          </Header>
            ...
            >
              ...
              <InputWrapper>
                ...
                <Input
                  type="text"
                  name="licenseNumber"
                  placeholder="Enter bank license number"
          ...
          <InfoText>
            Already registered? <a href="/bank_login">Login here</a>
          </InfoText>
        </FormCard>
      </PageContainer>
    )
...
export default withRouter(Bank_Register)
